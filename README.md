...
| [GSAP + ScrollTrigger](https://gsap.com/) | Animaciones y efectos al scroll |
| [PixiJS](https://pixijs.com/) | Canvas de partículas en el hero |
...
├── gsap.js             # Animaciones principales
...
- **Hero** — Animación de partículas con PixiJS, efecto glitch y texto tipado dinámico
- **Sobre mí** — Presentación con contadores animados
